...
interface ISpotMarketProxy {
    ...
    event SynthBought(uint256 indexed synthMarketId, uint256 synthReturned, S_1 fees, uint256 collectedFees, address referrer, uint256 price);
    event SynthSold(uint256 indexed synthMarketId, uint256 amountReturned, S_1 fees, uint256 collectedFees, address referrer, uint256 price);
    function buy(uint128 marketId, uint256 usdAmount, uint256 minAmountReceived, address referrer) external returns (uint256 synthAmount, S_1 memory fees);
    function buyExactIn(uint128 marketId, uint256 usdAmount, uint256 minAmountReceived, address referrer) external returns (uint256 synthAmount, S_1 memory fees);
    function buyExactOut(uint128 marketId, uint256 synthAmount, uint256 maxUsdAmount, address referrer) external returns (uint256 usdAmountCharged, S_1 memory fees);
    function getMarketSkew(uint128 marketId) external view returns (int256 marketSkew);
    function quoteBuyExactIn(uint128 marketId, uint256 usdAmount, uint8 stalenessTolerance) external view returns (uint256 synthAmount, S_1 memory fees);
    function quoteBuyExactOut(uint128 marketId, uint256 synthAmount, uint8 stalenessTolerance) external view returns (uint256 usdAmountCharged, S_1 memory fees);
    function quoteSellExactIn(uint128 marketId, uint256 synthAmount, uint8 stalenessTolerance) external view returns (uint256 returnAmount, S_1 memory fees);
    function quoteSellExactOut(uint128 marketId, uint256 usdAmount, uint8 stalenessTolerance) external view returns (uint256 synthToBurn, S_1 memory fees);
    function sell(uint128 marketId, uint256 synthAmount, uint256 minUsdAmount, address referrer) external returns (uint256 usdAmountReceived, S_1 memory fees);
    function sellExactIn(uint128 marketId, uint256 synthAmount, uint256 minAmountReceived, address referrer) external returns (uint256 returnAmount, S_1 memory fees);
    function sellExactOut(uint128 marketId, uint256 usdAmount, uint256 maxSynthAmount, address referrer) external returns (uint256 synthToBurn, S_1 memory fees);
    ...
    event OrderCancelled(uint128 indexed marketId, uint128 indexed asyncOrderId, S_2 asyncOrderClaim, address indexed sender);
    ...
    function commitOrder(uint128 marketId, uint8 orderType, uint256 amountProvided, uint256 settlementStrategyId, uint256 minimumSettlementAmount, address referrer) external returns (S_2 memory asyncOrderClaim);
    function getAsyncOrderClaim(uint128 marketId, uint128 asyncOrderId) external pure returns (S_2 memory asyncOrderClaim);
    ...
    event OrderSettled(uint128 indexed marketId, uint128 indexed asyncOrderId, uint256 finalOrderAmount, S_1 fees, uint256 collectedFees, address indexed settler, uint256 price, uint8 orderType);
    function settleOrder(uint128 marketId, uint128 asyncOrderId) external returns (uint256 finalOrderAmount, S_1 memory fees);
    ...
    event SettlementStrategySet(uint128 indexed synthMarketId, uint256 indexed strategyId, S_3 strategy);
    function addSettlementStrategy(uint128 marketId, S_3 memory strategy) external returns (uint256 strategyId);
    function getSettlementStrategy(uint128 marketId, uint256 strategyId) external view returns (S_3 memory settlementStrategy);
    function setSettlementStrategy(uint128 marketId, uint256 strategyId, S_3 memory strategy) external;
    ...
    event SynthUnwrapped(uint256 indexed synthMarketId, uint256 amountUnwrapped, S_1 fees, uint256 feesCollected);
    event SynthWrapped(uint256 indexed synthMarketId, uint256 amountWrapped, S_1 fees, uint256 feesCollected);
    ...
    function unwrap(uint128 marketId, uint256 unwrapAmount, uint256 minAmountReceived) external returns (uint256 returnCollateralAmount, S_1 memory fees);
    function wrap(uint128 marketId, uint256 wrapAmount, uint256 minAmountReceived) external returns (uint256 amountToMint, S_1 memory fees);
