...
interface ICoreProxy {
    ...
    function ccipReceive(S_3 memory message) external;
    ...
    function getLocks(uint128 accountId, address collateralType, uint256 offset, uint256 count) external view returns (S_4[] memory locks);
    function withdraw(uint128 accountId, address collateralType, uint256 tokenAmount) external;
    event CollateralConfigured(address indexed collateralType, S_5 config);
    function configureCollateral(S_5 memory config) external;
    function getCollateralConfiguration(address collateralType) external pure returns (S_5 memory);
    function getCollateralConfigurations(bool hideDisabled) external view returns (S_5[] memory);
    ...
    event Liquidation(uint128 indexed accountId, uint128 indexed poolId, address indexed collateralType, S_6 liquidationData, uint128 liquidateAsAccountId, address sender);
    event VaultLiquidation(uint128 indexed poolId, address indexed collateralType, S_6 liquidationData, uint128 liquidateAsAccountId, address sender);
    ...
    function liquidate(uint128 accountId, uint128 poolId, address collateralType, uint128 liquidateAsAccountId) external returns (S_6 memory liquidationData);
    function liquidateVault(uint128 poolId, address collateralType, uint128 liquidateAsAccountId, uint256 maxUsd) external returns (S_6 memory liquidationData);
    ...
    event PoolCollateralConfigurationUpdated(uint128 indexed poolId, address collateralType, S_7 config);
    event PoolCollateralDisabledByDefaultSet(uint128 poolId, bool disabled);
    event PoolConfigurationSet(uint128 indexed poolId, S_8[] markets, address indexed sender);
    ...
    function getPoolCollateralConfiguration(uint128 poolId, address collateralType) external view returns (S_7 memory config);
    function getPoolCollateralIssuanceRatio(uint128 poolId, address collateral) external view returns (uint256);
    function getPoolConfiguration(uint128 poolId) external view returns (S_8[] memory);
    ...
    function setPoolCollateralConfiguration(uint128 poolId, address collateralType, S_7 memory newConfig) external;
    function setPoolCollateralDisabledByDefault(uint128 poolId, bool disabled) external;
    function setPoolConfiguration(uint128 poolId, S_8[] memory newMarketConfigurations) external;
